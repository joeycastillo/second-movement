...
# Face dependencies: faces that require additional source files
FACE_DEPENDENCIES = {
    "comms_face": ["./watch-faces/io/comms_rx.c"],
}
...
def main():
    ...
    for face_id in face_ids:
        ...
        if path is None:
            ...
            # Include dependencies if face has any
            if face_id in FACE_DEPENDENCIES:
                for dep_path in FACE_DEPENDENCIES[face_id]:
                    lines.append("SRCS += {}\n".format(dep_path))
