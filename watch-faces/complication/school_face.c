...
void loadScheduleFromMemoryAndFile(school_state_t *state) {
    ...
    addDefaultSchedule( 5,false,state,"   ","  ","  ", 0, 0, 0, 0);
    addDefaultSchedule( 6,false,state,"   ","  ","  ", 0, 0, 0, 0);
    addDefaultSchedule( 7,false,state,"   ","  ","  ", 0, 0, 0, 0);
    addDefaultSchedule( 8,false,state,"   ","  ","  ", 0, 0, 0, 0);
    addDefaultSchedule( 9,false,state,"   ","  ","  ", 0, 0, 0, 0);
    addDefaultSchedule(10,false,state,"   ","  ","  ", 0, 0, 0, 0);
    addDefaultSchedule(11,false,state,"   ","  ","  ", 0, 0, 0, 0);
